...
\begin{frame}{\subsectiontitle}
 			\begin{itemize}
\item Engineered nanomaterials (eNMs) are broadly defined as compounds that exist on a scale of ~1–100 nm.in at least one of their dimensions. https://www.sciencedirect.com/topics/engineering/engineered-nanoparticles
\item Their safety assessment must cover the identification of:
\subitem{Physicochemical properties}
\subitem{Biological properties} https://www.beilstein-journals.org/bjnano/content/pdf/2190-4286-6-165.pdf
...
\begin{frame}{\subsectiontitle}
\includefigure{enm-structure.png}{AN overview of the upper levels, imports and manually annotated content going into the eNanoMapper ontology}
