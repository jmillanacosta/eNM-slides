...
\begin{frame}{\subsectiontitle}
    \begin{itemize}
        ...
        \item \textbf{The eNanoMapper ontology} is an application ontology and reuses parts of several ontologies to describe the full domain of nanomaterial safety assessment. \cite{hastings_enanomapper_2015}
    \end{itemize}
...
\begin{itemize}
    ...
    \item Alternatives:
        ...
        \subitem{Migration to the Ontology Development Kit-ROBOT - rethinking the whole process(ref figure)}
\end{itemize}
\end{frame}
